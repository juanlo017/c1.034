...
<acme:form>	
	...
	<acme:input-textbox code="any.training-module.form.label.difficulty-level" path="difficultyLevel" readonly="true"/>
	<acme:input-moment code="any.training-module.form.label.update-moment" path="updateMoment" readonly="true"/>
	<acme:input-url code="any.training-module.form.label.optionalLink" path="optionalLink" readonly="true"/>
	<acme:input-textbox code="any.training-module.form.label.estimated-total-time" path="totalTime" readonly="true"/>
</acme:form>