...
<acme:form>
	...
	<acme:input-moment code="any.sponsorship.form.label.startTime" path="startTime"/>	
	<acme:input-moment code="any.sponsorship.form.label.endTime" path="endTime"/>	
	...
	<acme:input-email code="any.sponsorship.form.label.optionalEmail" path="optionalEmail"/>	
	<acme:input-url code="any.sponsorship.form.label.optionalLink" path="optionalLink"/>
