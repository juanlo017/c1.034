...
<acme:menu-bar code="master.menu.home">
	<acme:menu-left>
		...
		<acme:menu-option code="master.menu.auditor" access="hasRole('Auditor')">
			<acme:menu-suboption code="master.menu.auditor.list.all.codeAudits" action="/auditor/codeAudits/list-all"/>
			<acme:menu-suboption code="master.menu.auditor.list.mine.codeAudits" action="/auditor/codeAudits/list-mine"/>
		</acme:menu-option>
