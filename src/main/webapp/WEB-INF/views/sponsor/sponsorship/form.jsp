...
<acme:form> 
	...
	<acme:input-email code="sponsor.sponsorship.form.label.optionalEmail" path="optionalEmail"/>
	<acme:input-url code="sponsor.sponsorship.form.label.optionalLink" path="optionalLink"/>
	<acme:input-textbox code="sponsor.sponsorship.form.label.draftMode" path="draftMode"/>
