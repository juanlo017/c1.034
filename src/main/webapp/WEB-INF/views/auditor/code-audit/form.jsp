...
<acme:form>
	...
	<acme:input-textarea code="auditor.code-audit.form.label.actions" path="actions"  />
	...
	<jstl:choose>
	 ...
	 <acme:input-textarea code="auditor.code-audit.form.label.executionDate" path="executionDate" readonly="true" />
			</jstl:when>
	</jstl:choose>
	<jstl:choose>
		...
		<jstl:when test="${_command == 'show'  && draftMode==false}  ">
			<acme:button code="auditor.audit-record.list.title" action="/auditor/audit-record/list-mine?masterId=${id}"/>
		</jstl:when>
